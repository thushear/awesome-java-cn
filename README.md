...
* Gradle：使用Groovy（非XML）进行增量构建，可以很好地与Maven依赖管理配合工作。[官网](http://www.gradle.org/)
...
* Grizzly：NIO框架，在Glassfish中作为网络层使用。[官网](https://grizzly.java.net/)
...
* RestX：基于朱洁处理和编译时源码生成的框架。[官网](http://restx.io)
